      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-purple-500/20 border border-purple-500/30 rounded-full px-4 py-1 mb-4">
            ...
            <span className="text-sm font-semibold text-purple-300">NEW IN v13.5 — THE DIALECTIC EDITION</span>
          </div>
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        {feature.tag && (
                          <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${
                            ...
                            feature.tag === "v13.5" ? "bg-cyan-500/20 text-cyan-400" :
        ...
        >
          <Button variant="outline" className="border-purple-500/30 text-purple-300 hover:bg-purple-500/10" asChild>
            <Link href="/read">
              Read Full ToE v13.5 <ArrowRight className="ml-2 w-4 h-4" />
            </Link>
          </Button>
        </motion.div>
      </div>
