 ...
 * Last updated: v17.0 Genre-Locking Edition — 38 Axiom Groups
 */
...
const PAGES: SearchItem[] = [
  ...
  },
  {
    ...
    content: "read theory full text document pdf download chapters sections toe v17.0 genre-locking edition",
    type: "page",
    path: "/read",
