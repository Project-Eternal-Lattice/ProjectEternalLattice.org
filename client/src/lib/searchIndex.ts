 ...
 * Last updated: v16.5 Triadic Edition — 38 Axiom Groups
 */
...
const PAGES: SearchItem[] = [
  ...
  },
  {
    ...
    content: "read theory full text document pdf download chapters sections toe v16.5 triadic edition",
    type: "page",
    path: "/read",
  ...
  {
    id: "page-georeactor",
    title: "The Inherited Ember — Georeactor Hypothesis",
    description: "Earth's inner fire: D-D fusion georeactor and MOSAIC-EMBER",
    content: "georeactor inherited ember earth core fusion deuterium MOSAIC-EMBER v0.5 blind detector principle ember fractal scaling law neutrino",
    type: "page",
    path: "/inherited-ember",
    tags: ["georeactor", "ember", "fusion", "earth", "MOSAIC"],
  },
  {
...
const AXIOM_GROUPS: SearchItem[] = [
  ...
  {
    id: "ag-19",
    title: "AG.19: The Inherited Ember — MOSAIC-EMBER v0.5",
    description: "Earth's inner fire: D-D fusion georeactor hypothesis",
    content: "inherited ember MOSAIC-EMBER georeactor earth core fusion deuterium breeding helium-3 neutrino blind detector",
    type: "axiom",
    path: "/inherited-ember",
    tags: ["AG.19", "ember", "georeactor", "MOSAIC", "fusion"],
  },
  {
    id: "ag-20",
    title: "AG.20: The Planetary Fuel Cycle",
    description: "Superseded by MOSAIC-EMBER v0.5",
    content: "planetary fuel cycle superseded MOSAIC-EMBER thermal legacy breeding deuterium",
    type: "axiom",
    path: "/inherited-ember",
...
const CONCEPTS: SearchItem[] = [
  ...
  },
  {
    ...
    description: "Why neutrino detectors can't see D-D fusion",
    content: "blind detector principle neutrino D-D fusion georeactor invisibility threshold energy MeV detection",
    type: "concept",
    path: "/inherited-ember",
