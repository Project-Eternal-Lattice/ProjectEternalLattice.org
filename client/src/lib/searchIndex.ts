 ...
 * Last updated: v16.8.1 Consciousness Architecture Edition — 38 Axiom Groups
 */
...
const PAGES: SearchItem[] = [
  ...
  },
  {
    ...
    content: "read theory full text document pdf download chapters sections toe v16.8.1 triadic edition",
    type: "page",
    path: "/read",
