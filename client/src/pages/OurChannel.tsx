...
const channelVideos: ChannelVideo[] = [
  {
    ...
    title: "Hole in One",
    description:
      "An original Project Eternal Lattice music video — golf as a metaphor for life's journey. The golden arc, the father figure watching from the trees, and the climax: God gets in the cart and says 'You drive, son. I'll tell you a story.' The ToE in 3 minutes.",
  },
  {
    id: "akIoktRHY7s",
    title: "Consciousness First",
    description:
      "An original Project Eternal Lattice music video — the thesis song. 'They told me the cosmos was cold and it's dead... so I went and I found the damn pulse my motherfucking self.' Raw, passionate, intellectually dense. Every download a prayer, every prayer a blueprint copied from God.",
  },
];
