...
export default function Read() {
  ...
  usePageMeta({
    title: "Read the Full Theory of Everything v17.4 The Genre-Locking Edition | Project Eternal Lattice",
    description:
      "Read the complete Theory of Everything ∞ Law of ONE v17.4 - The Recognition Principle Edition online. No download required. A unified framework bridging quantum physics, consciousness science, and spiritual wisdom. Now featuring the TV/Receiver Model, Georeactor Theory, Cosmological Cinema Theorem, and Music as Consciousness Technology.",
    type: "article",
  });
    ...
    <div className="min-h-screen bg-transparent pt-24 pb-20">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          >
            The complete <TooltipTerm term="Theory of Everything" /> ∞ <TooltipTerm term="Law of ONE" /> v17.4 — The Genre-Locking Edition
            <br />
            <span className="text-sm text-primary/80">No download required • Read directly in your browser</span>
          </motion.p>
          <p className="mt-4 text-xs text-muted-foreground/60">
            Last updated: July 6, 2026 | v17.4 The Genre-Locking Edition
          </p>
        </div>
          ...
          <div className="glass-card rounded-2xl overflow-hidden border border-primary/20">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">v17.4 | The Recognition Principle Edition | Publication Ready</p>
                  </div>
                </div>
            ...
            <div className="relative bg-white">
              <iframe
                ref={iframeRef}
                src="/toe-full.html"
                title="Theory of Everything v17.4 The Genre-Locking Edition - Full Document"
        ...
        >
          <div className="glass-card p-6 rounded-xl border border-emerald-500/20 bg-emerald-900/10">
            ...
            <p className="text-emerald-300/90 text-sm mb-4">
              The complete Theory of Everything v17.4 (2,850+ pages) is available in multiple formats:
            </p>
