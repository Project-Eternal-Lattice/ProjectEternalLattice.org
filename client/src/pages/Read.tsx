              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">v16.8.1 | The Consciousness Architecture Edition | Publication Ready</p>
                  </div>
                </div>
        ...
        >
          <div className="glass-card p-6 rounded-xl border border-emerald-500/20 bg-emerald-900/10">
            ...
            <p className="text-emerald-300/90 text-sm mb-4">
              The complete Theory of Everything v16.8.1 (2,850+ pages) is available in multiple formats:
            </p>
