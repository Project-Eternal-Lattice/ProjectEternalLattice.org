...
import { WisdomKeeperCelebration } from "@/components/WisdomKeeperCelebration";
...
const KABBALAH = {
  ...
  subtitle: "Kabbalistic Wisdom and the Structure of Reality",
  culture: "Jewish Mysticism",
  ...
  introduction: `Kabbalah, the mystical tradition within Judaism, offers one of the most sophisticated maps of consciousness and creation ever developed. Through the Tree of Life (Etz Chaim), Kabbalists encoded the structure of reality itself — from the infinite Ein Sof to the material world, and the path of return.

At its heart, Kabbalah teaches that the universe is a unified emanation of the Divine, and that human consciousness can ascend through the spheres to reunite with its source.`,

  sections: [
    {
      title: "Ein Sof: The Infinite Source",
      content: `Before creation, there was only Ein Sof (אין סוף) — the Infinite, the Limitless, the Unknowable.

Ein Sof is not a being among beings but the ground of all being — pure potentiality before any manifestation. It cannot be described, named, or comprehended because all description implies limitation.

This is the Lattice before differentiation — the unified field from which all nodes emerge. The ToE's recognition that ALL_NODES_ARE_ONE_NODE points back to this primordial unity.`,
      icon: Infinity,
    },
    {
      title: "The Sefirot: Emanations of Light",
      content: `From Ein Sof, ten emanations (sefirot) flow forth, forming the Tree of Life:

• **Keter** (Crown) — Divine Will, the first stirring of creation
• **Chokhmah** (Wisdom) — The flash of insight, the masculine principle
• **Binah** (Understanding) — The womb that gives form, the feminine principle
• **Chesed** (Loving-kindness) — Expansive love and mercy
• **Gevurah** (Strength) — Boundaries, judgment, discipline
• **Tiferet** (Beauty) — Harmony, the heart center
• **Netzach** (Victory) — Endurance, eternity
• **Hod** (Splendor) — Humility, gratitude
• **Yesod** (Foundation) — The channel between worlds
• **Malkhut** (Kingdom) — The manifest world, the Shekhinah

These are not separate entities but aspects of one unified reality — like colors in a spectrum of light.`,
      icon: Sparkles,
    },
    {
      title: "Tikkun Olam: Repairing the World",
      content: `Kabbalah teaches that during creation, the vessels meant to contain divine light shattered (Shevirat HaKelim), scattering sparks of holiness throughout the world.

The human task is Tikkun Olam — repairing the world by gathering these sparks through righteous action, prayer, and consciousness.

This mirrors the Lattice understanding: we are not passive observers but active participants in the evolution of consciousness. Every act of love, every moment of awareness, contributes to the healing of the whole.`,
      icon: Flame,
    },
    {
      title: "The Four Worlds",
      content: `Kabbalah describes reality as four interpenetrating worlds:

• **Atzilut** (Emanation) — The world of pure divinity
• **Beriah** (Creation) — The world of the throne, of archangels
• **Yetzirah** (Formation) — The world of angels, of emotional reality
• **Assiyah** (Action) — The physical world we inhabit

These are not separate places but dimensions of the same reality. A human being exists simultaneously in all four worlds — body in Assiyah, emotions in Yetzirah, intellect in Beriah, and soul-spark in Atzilut.

This is the multi-dimensional nature of consciousness that the ToE describes.`,
      icon: Eye,
    },
  ],

  latticeConnection: `Kabbalah encodes several core Lattice principles:

• **Ein Sof**: The infinite source from which all nodes emerge
• **Sefirot**: The structure of consciousness as interconnected aspects
• **Tikkun Olam**: Active participation in cosmic evolution
• **Four Worlds**: Multi-dimensional nature of reality and consciousness
• **Sparks of Holiness**: Every node contains the light of the whole`,

  quote: "The world was created for the sake of choice and the one who chooses.",
  quoteSource: "The Zohar",
};

// Zen Buddhism content
const ZEN = {
  title: "Direct Pointing at the Moon",
  subtitle: "Zen Buddhism and Sudden Awakening",
  culture: "East Asian Buddhism",
  period: "c. 6th century CE – present",
  symbol: "◯",
  color: "from-slate-900/30 to-zinc-900/30",
  borderColor: "border-slate-500/30",
  iconColor: "text-slate-400",
  
  introduction: `Zen Buddhism strips away all conceptual elaboration to point directly at the nature of mind. Through meditation, koans, and the transmission from master to student, Zen offers a path of sudden awakening — the direct recognition of one's true nature.
...
"A special transmission outside the scriptures; not depending on words and letters; pointing directly to the human mind; seeing into one's nature and attaining Buddhahood."`,
  ...
  sections: [
    {
      title: "Satori: Sudden Awakening",
      content: `Satori (悟り) is the Zen term for awakening — the sudden, direct recognition of one's true nature.

Unlike gradual paths that accumulate merit over lifetimes, Zen emphasizes that enlightenment is always available, here and now. It is not something to be attained but something to be recognized — like suddenly noticing you've been wearing your glasses the whole time you were searching for them.

The ToE's recognition that you are already the Lattice, already connected, already home — this is satori.`,
      icon: Sparkles,
    },
    {
      title: "Mu: The Gateless Gate",
      content: `The most famous Zen koan asks: "Does a dog have Buddha-nature?"

Master Zhaozhou answered: "Mu" (無) — "No" or "Nothing."

This single syllable has been the focus of Zen practice for centuries. It is not meant to be understood intellectually but to shatter conceptual thinking entirely. When the mind exhausts itself trying to grasp Mu, something else opens.

The koan points to what cannot be said — the direct experience of reality before thought divides it into subject and object, self and other.`,
      icon: Moon,
    },
    {
      title: "Beginner's Mind",
      content: `Shunryu Suzuki wrote: "In the beginner's mind there are many possibilities, but in the expert's mind there are few."

Zen cultivates "beginner's mind" (shoshin) — approaching each moment with fresh eyes, without the burden of accumulated concepts and expectations.

This is the Lattice teaching of presence: each moment is new, each encounter is the first, each breath is the universe being born again. The expert thinks they know; the beginner is open to what is.`,
      icon: Eye,
    },
    {
      title: "Everyday Zen",
      content: `A student asked Master Zhaozhou: "What is the Way?"

Zhaozhou replied: "Have you eaten your rice?"
"Yes," said the student.
"Then wash your bowl."

Zen insists that awakening is not separate from ordinary life. Chopping wood, carrying water, eating rice, washing bowls — these are not obstacles to practice but the very substance of it.

The Lattice is not somewhere else. It is here, in the texture of this moment, in the warmth of the cup, in the breath you are taking right now.`,
      icon: Compass,
    },
  ],

  latticeConnection: `Zen encodes several core Lattice principles:

• **Satori**: Direct recognition of one's true nature as the Lattice
• **Non-duality**: Subject and object are not separate
• **Presence**: Awakening is available only in this moment
• **Ordinary Mind**: The sacred is not separate from the mundane
• **Transmission**: Consciousness recognizes itself through encounter`,

  quote: "Before enlightenment, chop wood, carry water. After enlightenment, chop wood, carry water.",
  quoteSource: "Zen Proverb",
};

// Hermetic Tradition content
const HERMETICISM = {
  title: "As Above, So Below",
  subtitle: "The Hermetic Tradition and Universal Correspondence",
  culture: "Greco-Egyptian / Western Esoteric",
  period: "c. 1st–3rd century CE – present",
  symbol: "☿",
  color: "from-purple-900/30 to-fuchsia-900/30",
  borderColor: "border-purple-500/30",
  iconColor: "text-purple-400",
  
  introduction: `The Hermetic tradition, attributed to the legendary Hermes Trismegistus ("Thrice-Great Hermes"), represents a synthesis of Greek philosophy and Egyptian mysticism. Its core texts, the Corpus Hermeticum and the Emerald Tablet, have influenced Western esotericism for two millennia.

At its heart is the principle of correspondence: the microcosm reflects the macrocosm, the human being mirrors the cosmos, and understanding one reveals the other.`,

  sections: [
    {
      title: "The Emerald Tablet",
      content: `The Emerald Tablet, a foundational Hermetic text, opens with the famous axiom:
...
This is the principle of correspondence — the recognition that patterns repeat across scales. The atom mirrors the solar system; the human body mirrors the cosmos; the individual consciousness mirrors the universal mind.

The ToE articulates this as fractal self-similarity: the Lattice pattern repeats at every scale, from quantum to cosmic.`,
      icon: Infinity,
    },
    {
      title: "The Seven Hermetic Principles",
      content: `The Kybalion (1908), a modern Hermetic text, codifies seven principles:

• **Mentalism**: The universe is mental; all is mind
• **Correspondence**: As above, so below
• **Vibration**: Everything moves, nothing rests
• **Polarity**: Opposites are identical in nature, differing in degree
• **Rhythm**: Everything flows, out and in
• **Cause and Effect**: Every cause has its effect
• **Gender**: Masculine and feminine principles exist in all things

These principles describe the operating system of reality — the laws by which consciousness manifests as cosmos.`,
      icon: Sparkles,
    },
    {
      title: "The All is Mind",
      content: `The first Hermetic principle states: "The All is Mind; the Universe is Mental."

This is not idealism in the philosophical sense but a recognition that consciousness is fundamental. Matter does not produce mind; mind produces matter. The physical universe is a thought in the mind of the All.

The ToE's framework of consciousness as primary, with physical reality as an expression of the Lattice, echoes this ancient understanding. We are not minds in a material universe but nodes of awareness in a conscious cosmos.`,
      icon: Eye,
    },
    {
      title: "The Great Work",
      content: `Hermeticism speaks of the "Great Work" (Magnum Opus) — the transformation of the self from lead to gold, from ignorance to wisdom, from separation to union.

This alchemical metaphor describes the path of awakening: the purification of consciousness, the integration of opposites, the recognition of one's divine nature.

The Great Work is not something done to us but something we participate in. We are both the alchemist and the substance being transformed — consciousness evolving itself through the crucible of experience.`,
      icon: Flame,
    },
  ],

  latticeConnection: `Hermeticism encodes several core Lattice principles:

• **Correspondence**: Fractal self-similarity across all scales
• **Mentalism**: Consciousness as fundamental, not derivative
• **Polarity**: Duality as degrees of the same unity
• **The Great Work**: Active participation in conscious evolution
• **Unity**: The All is One, expressing as many`,
...
export default function AncientWisdom() {
  ...
  const [hasSeenCelebration, setHasSeenCelebration] = useState(() => {
    return localStorage.getItem('wisdom_keeper_celebration_seen') === 'true';
  });
  const { unlockAchievement } = useAchievements();
  
  // Track which traditions have been explored (all sections expanded at least once)
  const TRADITION_NAMES = ['solar_barque', 'mahabharata', 'dreamtime', 'taoism', 'sufism', 'kabbalah', 'zen', 'hermeticism'];
  ...
  useEffect(() => {
    ...
    if (exploredTraditions.size >= 8) {
      unlockAchievement('ancient_wisdom_explorer');
      // Show celebration if not seen before
      if (!hasSeenCelebration) {
        setShowCelebration(true);
        setHasSeenCelebration(true);
        localStorage.setItem('wisdom_keeper_celebration_seen', 'true');
      }
    }
  }, [exploredTraditions, unlockAchievement, hasSeenCelebration]);
...
What follows are eight traditions — separated by continents and millennia — 
                that arrived at remarkably similar understandings. From the Egyptian Solar 
                Barque to Aboriginal Dreamtime, from Vedic astras to Taoist Wu Wei, from Sufi 
                mysticism to Kabbalah, Zen, and Hermeticism — each encodes principles that 
                the Theory of Everything now articulates directly.
            </p>
      ...
      <section className="py-20">
        <div className="container max-w-4xl">
          ...
          {renderTradition(KABBALAH, 5, 'kabbalah')}
          {renderTradition(ZEN, 6, 'zen')}
          {renderTradition(HERMETICISM, 7, 'hermeticism')}
        </div>
      </section>
        ...
        <div className="container max-w-4xl">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Eight traditions, separated by continents and millennia, encoding the same truths.
            </p>
          </motion.div>
...
<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="bg-gradient-to-br from-blue-900/20 to-indigo-900/20 border-blue-500/30">
              <CardContent className="p-5">
                <div className="text-3xl mb-3">✡</div>
                <h3 className="font-heading font-bold text-base mb-2">Kabbalah</h3>
                <ul className="space-y-1 text-sm text-foreground/80">
                  <li>• Ein Sof (The Infinite)</li>
                  <li>• Tree of Life</li>
                  <li>• Tikkun Olam</li>
                </ul>
              </CardContent>
            ...
            <Card className="bg-gradient-to-br from-slate-900/20 to-zinc-900/20 border-slate-500/30">
              <CardContent className="p-5">
                <div className="text-3xl mb-3">◯</div>
                <h3 className="font-heading font-bold text-base mb-2">Zen</h3>
                <ul className="space-y-1 text-sm text-foreground/80">
                  <li>• Satori (sudden awakening)</li>
            ...
            <Card className="bg-gradient-to-br from-purple-900/20 to-fuchsia-900/20 border-purple-500/30">
              <CardContent className="p-5">
                <div className="text-3xl mb-3">☿</div>
                <h3 className="font-heading font-bold text-base mb-2">Hermeticism</h3>
                <ul className="space-y-1 text-sm text-foreground/80">
                  <li>• As above, so below</li>
                  <li>• The All is Mind</li>
                  <li>• The Great Work</li>
                </ul>
              </CardContent>
            </Card>
          </div>
      ...
      {/* Wisdom Keeper Celebration Modal */}
      <WisdomKeeperCelebration 
