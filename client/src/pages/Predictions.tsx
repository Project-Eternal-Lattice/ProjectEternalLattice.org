...
const predictions: Prediction[] = [
  ...
  },
  {
    ...
    timeline: "2-5 years",
    source: "Three-Layer Model v3.1, Part Seven",
    notes: "PLCR instrument does not appear to exist as validated scale — needs resolution before study proposal.",
  },
  {
    id: "A-007",
  ...
  {
    id: "S-002",
    title: "Neighbors Hypothesis",
    claim: "Earth's deep subsurface may harbor intelligent life that has evolved over 4 billion years of uninterrupted development — far longer than surface life.",
    domain: "consciousness",
    status: "speculative",
    tier: 3,
    howToFalsify: "If deep subsurface exploration finds no complex life beyond simple extremophiles, the hypothesis is weakened.",
    currentEvidence: "Deep subsurface biosphere confirmed (extremophiles). No evidence of complex intelligence.",
    timeline: "Decades to centuries",
    source: "Kenneth's Morning Conversation with Resonance",
    notes: "Zero direct evidence. Tier 3/SPECULATIVE. Interesting but ungrounded.",
  },
  {
    id: "S-003",
