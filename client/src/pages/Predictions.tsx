...
const predictions: Prediction[] = [
  ...
  {
    id: "A-010",
    title: "Grief Trajectory: Exponential Bond Dissolution (\u03B3 \u2248 0.17 yr\u207B\u00B9)",
    claim: "Attachment bond dissolution after loss follows approximate exponential decay with rate \u03B3 \u2248 0.17 yr\u207B\u00B9 (half-life \u2248 4 years) for the modal recovery trajectory, as predicted by the Kuramoto sector of the framework's Lagrangian.",
    domain: "consciousness",
    status: "awaiting",
    tier: 2,
    howToFalsify: "If longitudinal studies of consciousness-depth changes during bereavement show no exponential structure, or if the timescale is off by an order of magnitude, the prediction fails.",
    currentEvidence: "Strong empirical support: Chong & Fraley (2025) found 4.18-year midpoint for romantic bond dissolution (\u03B3 = 0.166 yr\u207B\u00B9). Burke et al. (2007) confirmed exponential decay model for grief depression (S \u2248 0.39 yr\u207B\u00B9 for symptoms, longer for bonds). Multiple trajectory types exist with substantial individual variability (\u03C3_S \u2248 0.27 yr\u207B\u00B9).",
    timeline: "Testable NOW (longitudinal bereavement studies with depth battery)",
    source: "Physics Core v1.1, Part Six (Grief Equation); H1",
    notes: "O5 status: RESOLVED (partial \u2192 strong empirical support). The framework correctly identifies BOND dissolution (not symptom recovery) as the relevant timescale. Remaining gap: need depth-battery (D) measurements applied longitudinally to bereaved populations.",
  },
  {
    id: "A-009",
